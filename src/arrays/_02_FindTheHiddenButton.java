...
public class _02_FindTheHiddenButton implements ActionListener {
	...
	public void start() {
		...
		numofbuttons = Integer.parseInt(answer);
		...
		JOptionPane.showMessageDialog(null, "A button will flash and tell you that it is the hidden button."
				+ " You have to find it, or else... you lose!");
		// 13. initialize the hiddenButton variable to a random number less than the int
		// created int step 3

		hb = r.nextInt(numofbuttons - 1);
